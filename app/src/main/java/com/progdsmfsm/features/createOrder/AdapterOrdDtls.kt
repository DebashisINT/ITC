...
class AdapterOrdDtls(var mContext: Context,var prodL:ArrayList<NewOrderProductEntity>):
    ...
    inner class OrdDtlsViewHolder(itemView: View):RecyclerView.ViewHolder(itemView){
        fun bindItems(context: Context, mlist:ArrayList<NewOrderProductEntity>){
