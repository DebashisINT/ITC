package com.progdsmfsm.features.logoutsync.presentation
...
import com.progdsmfsm.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.progdsmfsm.features.billing.api.AddBillingRepoProvider
import com.progdsmfsm.features.billing.model.AddBillingInputParamsModel
...
import com.progdsmfsm.features.createOrder.OrdID
import com.progdsmfsm.features.createOrder.SyncOrd
import com.progdsmfsm.features.createOrder.SyncOrdProductL
...
import com.progdsmfsm.features.document.model.AddEditDocumentInputParams
import com.progdsmfsm.features.document.model.DocumentAttachmentModel
...
import com.progdsmfsm.features.orderhistory.model.*
...
import com.progdsmfsm.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.progdsmfsm.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.progdsmfsm.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.progdsmfsm.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.progdsmfsm.features.timesheet.model.AddTimeSheetInputModel
import com.progdsmfsm.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.progdsmfsm.features.viewAllOrder.model.AddOrderInputParamsModel
import com.progdsmfsm.features.viewAllOrder.model.AddOrderInputProductList
...
//                                (mContext as DashboardActivity).showSnackMessage("ERROR")
    ...
    private fun checkToCallActivity() {
        ...
        Timber.d("==============checkToCallActivity (Logout Sync)====================" + "   MonitorService Stop , MonitorBrodcastStop")

        try{
            Timber.d("==Logout Sync " + "   WorkManager stop")
            ...
            BaseActivity.compositeDisposable.add(
                repository.deleteConcurrentUserDtls(Pref.user_login_ID)
                    ...
                    .subscribe({ result ->
                        ...
                        Timber.d("deleteConcurrentUserDtls : " + "response : " + response.status + "Time : " + AppUtils.getCurrentDateTime())
                        if (response.status == NetworkConstant.SUCCESS) {
//                            calllogoutApi(Pref.user_id!!, Pref.session_token!!)
                            callLogshareApi()
                        }
...
//                            calllogoutApi(Pref.user_id!!, Pref.session_token!!)
                        ...
                        progress_wheel.stopSpinning()
                        error.printStackTrace()
                        Timber.d("deleteConcurrentUserDtls : " + "error : " + error.message + "\n" + "Time : " + AppUtils.getCurrentDateTime())
//                        calllogoutApi(Pref.user_id!!, Pref.session_token!!)
                        callLogshareApi()
            ...
            progress_wheel.stopSpinning()
            ex.printStackTrace()
            Timber.d("deleteConcurrentUserDtls : " + "catch : " + ex.message + "\n" + "Time : " + AppUtils.getCurrentDateTime())
//            calllogoutApi(Pref.user_id!!, Pref.session_token!!)
            callLogshareApi()
    ...
    private fun callLogshareApi(){
        Pref.LogoutWithLogFile = false
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xprogdsmfsmlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xprogdsmfsmlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xprogdsmfsmlogsample/log.zip").path);
...
//            }
    ...
    private fun logoutYesClick() {
        ...
        SendBrod.stopBrod(mContext)
        Timber.d("==============logoutYesClick (Logout Sync)====================" + "   MonitorService Stop , MonitorBrodcastStop")
