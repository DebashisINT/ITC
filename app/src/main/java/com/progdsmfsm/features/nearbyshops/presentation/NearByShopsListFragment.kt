...
import com.progdsmfsm.app.utils.AppUtils.Companion.changeAttendanceDateFormatToCurrent
...
import com.progdsmfsm.features.addshop.presentation.StageListDialog
...
import com.progdsmfsm.features.marketing.api.marketingcategorylist.MarketingCatListRepoProvider
import com.progdsmfsm.features.marketing.model.MarketingCategoryListResponse
...
import com.progdsmfsm.features.nearbyshops.diaog.ShopInactiveDialog
import com.progdsmfsm.features.nearbyshops.model.ShopData
import com.progdsmfsm.features.nearbyshops.model.ShopListResponse
import com.progdsmfsm.features.nearbyshops.model.StageListResponseModel
import com.progdsmfsm.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.progdsmfsm.features.photoReg.present.UpdateDSTypeStatusDialog
                    ...
                    repository.editShop(addShopReqData)
                            ...
                            .subscribe({ result ->
                                ...
                                if (addShopResult.status == NetworkConstant.SUCCESS) {
                                    ...
                                    progress_wheel.stopSpinning()
                                    Timber.d("Edit Shop : else " + ", SHOP: " + addShopReqData.shop_name + ", RESPONSE:" + result.message)
                                    if (isSync)
                                ...
                                Timber.d("Edit Shop : error " + ", SHOP: " + addShopReqData.shop_name + ", err :" + error.message)
