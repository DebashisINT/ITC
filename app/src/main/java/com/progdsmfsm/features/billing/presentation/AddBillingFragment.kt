package com.progdsmfsm.features.billing.presentation
...
import com.progdsmfsm.app.utils.ImagePickerManager
import com.progdsmfsm.app.utils.InputFilterDecimal
import com.progdsmfsm.app.utils.PermissionUtils
import com.progdsmfsm.app.utils.swipemenulayout.SwipeMenuRecyclerView
...
//                                (mContext as DashboardActivity).showSnackMessage("ERROR")
    ...
    private fun getAssignedDDListApi(shop_id: String?, billing: BillingEntity) {
        ...
        if (BaseActivity.isApiInitiated)
            return
        Timber.d("tag_itc_check assignToDDList call AddBillingFRagment")
        BaseActivity.isApiInitiated = true
    ...
    private fun getAssignedToShopApi(shop_id: String?, billing: BillingEntity) {
        ...
        if (BaseActivity.isApiInitiated)
            return
        Timber.d("tag_itc_check getAssignedToShopList call AddBillingFragment")
        BaseActivity.isApiInitiated = true
