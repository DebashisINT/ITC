...
import kotlinx.android.synthetic.main.row_ds_status.view.tv_ds_status

class DsStatusAdapter1 (var context: Context, var dsList:ArrayList<StageEntity>, var listner: DsStatusListner):
    RecyclerView.Adapter<DsStatusAdapter1.DsStatusViewHolder>(){
    ...
    override fun onBindViewHolder(holder: DsStatusViewHolder, position: Int) {
        holder.tv_ds.text=dsList.get(position).stage_name
