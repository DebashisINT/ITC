...
package com.progdsmfsm.faceRec;
...
import com.progdsmfsm.faceRec.customview.OverlayView;
import com.progdsmfsm.faceRec.env.BorderedText;
import com.progdsmfsm.faceRec.env.ImageUtils;
import com.progdsmfsm.faceRec.env.Logger;
import com.progdsmfsm.faceRec.tflite.SimilarityClassifier;
import com.progdsmfsm.faceRec.tracking.MultiBoxTracker;
...
//        final int inHeight = transpose ? srcWidth : srcHeight;
  ...
  private void onFacesDetected(long currTimestamp, List<Face> faces, boolean add) {
    ...
    for (Face face : faces) {
      ...
      if(!CustomStatic.IsFaceRecognitionOnEyeblink)
        isTrueFace=true;
