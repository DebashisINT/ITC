...
//                .tag(getString(R.string.global_tag))                   // Specify TAG, default: "X-LOG"
        ...
        //val filePrinter = FilePrinter.Builder(File(getExternalStorageDirectory(), "xprogdsmfsmlogsample").path)// Printer that print the log to the file system
        val filePrinter = FilePrinter.Builder(File(getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xprogdsmfsmlogsample").path)// Printer that print the log to the file system
