package com.progdsmfsm.app.utils
...
import com.progdsmfsm.app.domain.EntityTypeEntity
import com.progdsmfsm.app.domain.PartyStatusEntity
import com.progdsmfsm.app.domain.ShopDeactivateEntity
import com.progdsmfsm.app.types.FragType
import com.progdsmfsm.features.alarm.model.AlarmData
import com.progdsmfsm.features.broadcastreceiver.ActionReceiver
...
//        shopIntent.setClassName("com.progdsmfsm.features.dashboard.presentation", "com.progdsmfsm.features.dashboard.presentation.DashboardActivity")
//        shopIntent.putExtra("ALARM_DATA", alarmData)
...
//                /*PendingIntent.FLAG_IMMUTABLE*/ 0)
    ...
    @RequiresApi(Build.VERSION_CODES.O)
    fun sendFCMNotificaitonShopStatusUpdate(applicationContext: Context, remoteMessage: RemoteMessage?) {
        ...
        val shopIntent = Intent(applicationContext, DashboardActivity::class.java)
        shopIntent.putExtra("TYPE", "RECEIVER_SHOP_STATUS")
        shopIntent.putExtra("shopID", remoteMessage?.data?.get("body1"))
        shopIntent.action = Intent.ACTION_MAIN
        shopIntent.addCategory(Intent.CATEGORY_LAUNCHER)
