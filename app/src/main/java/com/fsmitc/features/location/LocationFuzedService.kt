package com.fsmitc.features.location
...
import com.fsmitc.MonitorBroadcast
...
import com.fsmitc.app.Pref.tempDistance
import com.fsmitc.app.domain.*
import com.fsmitc.app.utils.AppUtils
import com.fsmitc.app.utils.AppUtils.Companion.getDateTimeFromTimeStamp
import com.fsmitc.app.utils.AppUtils.Companion.isLocationActivityUpdating
...
import com.fsmitc.base.presentation.BaseActivity.Companion.isMeetingUpdating
import com.fsmitc.base.presentation.BaseActivity.Companion.isShopActivityUpdating
...
import com.fsmitc.features.dashboard.presentation.SystemEventReceiver
...
import com.fsmitc.features.gpsstatus.GpsReceiver
import com.fsmitc.features.gpsstatus.LocationCallBack
import com.fsmitc.features.location.LocationWizard.Companion.NEARBY_RADIUS
import com.fsmitc.features.location.api.LocationRepoProvider
import com.fsmitc.features.location.ideallocapi.IdealLocationRepoProvider
...
import com.fsmitc.features.orderhistory.model.LocationUpdateRequest
import com.fsmitc.mappackage.SendBrod.Companion.monitorNotiID
...
//3000(millliseconds in a second)*60(seconds in a minute)*5(number of minutes)=300000
    ...
    private fun shouldLocationActivityUpdate(): Boolean {
        AppUtils.changeLanguage(this,"en")
        return if (abs(System.currentTimeMillis() - Pref.prevLocationActivityTimeStamp) > 1000 * 60 * 2) {
