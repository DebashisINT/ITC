package com.fsmitc.features.dashboard.presentation
...
import com.fsmitc.R
import com.fsmitc.app.*
import com.fsmitc.app.NewFileUtils.browseDocuments
import com.fsmitc.app.NewFileUtils.getExtension
import com.fsmitc.app.domain.*
import com.fsmitc.app.types.DashboardType
import com.fsmitc.app.types.FragType
import com.fsmitc.app.types.TopBarConfig
import com.fsmitc.app.uiaction.DisplayAlert
import com.fsmitc.app.utils.*
import com.fsmitc.app.utils.AppUtils.Companion.isProfile
...
import com.fsmitc.features.SearchLocation.SearchLocationFragment
import com.fsmitc.features.SearchLocation.locationInfoModel
import com.fsmitc.features.TA.ViewAllTAListFragment
import com.fsmitc.features.achievement.AchievementFragment
import com.fsmitc.features.activities.presentation.*
import com.fsmitc.features.addAttendence.*
import com.fsmitc.features.addorder.presentation.AddOrderFragment
import com.fsmitc.features.addshop.model.AddShopRequestData
import com.fsmitc.features.addshop.model.AddShopResponse
import com.fsmitc.features.addshop.presentation.AddShopFragment
import com.fsmitc.features.addshop.presentation.OTPVerificationDialog
import com.fsmitc.features.addshop.presentation.ScanImageFragment
import com.fsmitc.features.addshop.presentation.ShowCardDetailsDialog
import com.fsmitc.features.alarm.model.AlarmData
import com.fsmitc.features.alarm.presetation.AttendanceReportFragment
import com.fsmitc.features.alarm.presetation.PerformanceReportFragment
import com.fsmitc.features.alarm.presetation.VisitReportDetailsFragment
import com.fsmitc.features.alarm.presetation.VisitReportFragment
import com.fsmitc.features.attendance.AttendanceFragment
import com.fsmitc.features.averageshop.presentation.AverageShopFragment
import com.fsmitc.features.avgorder.presentation.AverageOrderFragment
import com.fsmitc.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.fsmitc.features.billing.presentation.AddBillingFragment
import com.fsmitc.features.billing.presentation.BillingDetailsFragment
import com.fsmitc.features.billing.presentation.BillingListFragment
import com.fsmitc.features.changepassword.presentation.ChangePasswordDialog
import com.fsmitc.features.chat.model.ChatListDataModel
import com.fsmitc.features.chat.model.ChatUserDataModel
import com.fsmitc.features.chat.model.GroupUserDataModel
import com.fsmitc.features.chat.presentation.*
import com.fsmitc.features.chatbot.presentation.ChatBotFragment
import com.fsmitc.features.chatbot.presentation.ChatBotShopListFragment
import com.fsmitc.features.chatbot.presentation.ReportsFragment
import com.fsmitc.features.chatbot.presentation.SelectLanguageDialog
import com.fsmitc.features.commondialog.presentation.CommonDialog
import com.fsmitc.features.commondialog.presentation.CommonDialogClickListener
import com.fsmitc.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.fsmitc.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.fsmitc.features.commondialogsinglebtn.OnDialogClickListener
import com.fsmitc.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.fsmitc.features.dailyPlan.prsentation.AllShopListFragment
import com.fsmitc.features.dailyPlan.prsentation.DailyPlanListFragment
import com.fsmitc.features.dailyPlan.prsentation.PlanDetailsFragment
import com.fsmitc.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.fsmitc.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.fsmitc.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.fsmitc.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.fsmitc.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.fsmitc.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.fsmitc.features.dashboard.presentation.model.ContentListResponseModel
import com.fsmitc.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.fsmitc.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.fsmitc.features.device_info.presentation.DeviceInfoListFragment
import com.fsmitc.features.document.DocumentRepoFeatureNewFragment
import com.fsmitc.features.document.presentation.DocumentListFragment
import com.fsmitc.features.document.presentation.DocumentTypeListFragment
import com.fsmitc.features.dymanicSection.presentation.AddDynamicFragment
import com.fsmitc.features.dymanicSection.presentation.AllDynamicListFragment
import com.fsmitc.features.dymanicSection.presentation.DynamicListFragment
import com.fsmitc.features.dymanicSection.presentation.EditDynamicFragment
import com.fsmitc.features.gpsDisabilityScreen.GpsDisableFragment
import com.fsmitc.features.home.presentation.HomeFragment
import com.fsmitc.features.homelocation.presentation.HomeLocationFragment
import com.fsmitc.features.homelocation.presentation.HomeLocationMapFragment
import com.fsmitc.features.know_your_state.KnowYourStateFragment
import com.fsmitc.features.localshops.LocalShopListFragment
import com.fsmitc.features.localshops.LocalShopListMapFragment
import com.fsmitc.features.localshops.NearByShopsMapFragment
import com.fsmitc.features.location.*
import com.fsmitc.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.fsmitc.features.login.presentation.LoginActivity
import com.fsmitc.features.logout.presentation.api.LogoutRepositoryProvider
import com.fsmitc.features.logoutsync.presentation.LogoutSyncFragment
import com.fsmitc.features.marketing.presentation.MarketingPagerFragment
import com.fsmitc.features.meetinglist.prsentation.MeetingListFragment
import com.fsmitc.features.member.model.TeamLocDataModel
import com.fsmitc.features.member.model.TeamShopListDataModel
import com.fsmitc.features.member.presentation.*
import com.fsmitc.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.fsmitc.features.micro_learning.presentation.MicroLearningListFragment
import com.fsmitc.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.fsmitc.features.myallowancerequest.MyallowanceRequestFragment
import com.fsmitc.features.myjobs.model.CustomerDataModel
import com.fsmitc.features.myjobs.presentation.*
import com.fsmitc.features.myorder.presentation.MyOrderListFragment
import com.fsmitc.features.myprofile.presentation.MyProfileFragment
import com.fsmitc.features.nearbyshops.presentation.BeatListFragment
import com.fsmitc.features.nearbyshops.presentation.NearByShopsListFragment
import com.fsmitc.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.fsmitc.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.fsmitc.features.newcollection.CollectionDetailsStatusFragment
import com.fsmitc.features.newcollection.CollectionShopListFragment
import com.fsmitc.features.newcollection.NewCollectionListFragment
import com.fsmitc.features.notification.NotificationFragment
import com.fsmitc.features.orderList.NewDateWiseOrderListFragment
import com.fsmitc.features.orderList.NewOrderListFragment
import com.fsmitc.features.orderList.OrderListFragment
import com.fsmitc.features.orderdetail.presentation.OrderDetailFragment
import com.fsmitc.features.orderhistory.ActivityMapFragment
import com.fsmitc.features.orderhistory.OrderhistoryFragment
import com.fsmitc.features.orderhistory.TimeLineFragment
import com.fsmitc.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.fsmitc.features.orderhistory.model.FetchLocationRequest
import com.fsmitc.features.orderhistory.model.FetchLocationResponse
import com.fsmitc.features.orderhistory.model.LocationData
import com.fsmitc.features.performance.GpsStatusFragment
import com.fsmitc.features.performance.PerformanceFragment
import com.fsmitc.features.performance.api.UpdateGpsStatusRepoProvider
import com.fsmitc.features.performance.model.UpdateGpsInputParamsModel
import com.fsmitc.features.permissionList.ViewPermissionFragment
import com.fsmitc.features.photoReg.ProtoRegistrationFragment
import com.fsmitc.features.photoReg.RegisTerFaceFragment
import com.fsmitc.features.quotation.presentation.*
import com.fsmitc.features.reimbursement.presentation.EditReimbursementFragment
import com.fsmitc.features.reimbursement.presentation.ReimbursementDetailsFragment
import com.fsmitc.features.reimbursement.presentation.ReimbursementFragment
import com.fsmitc.features.reimbursement.presentation.ReimbursementListFragment
import com.fsmitc.features.report.presentation.*
import com.fsmitc.features.settings.presentation.SettingsFragment
import com.fsmitc.features.shopdetail.presentation.*
import com.fsmitc.features.shopdetail.presentation.api.EditShopRepoProvider
import com.fsmitc.features.stock.StockDetailsFragment
import com.fsmitc.features.stock.StockListFragment
import com.fsmitc.features.stockAddCurrentStock.AddShopStockFragment
import com.fsmitc.features.stockAddCurrentStock.UpdateShopStockFragment
import com.fsmitc.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.fsmitc.features.stockCompetetorStock.AddCompetetorStockFragment
import com.fsmitc.features.stockCompetetorStock.CompetetorStockFragment
import com.fsmitc.features.stockCompetetorStock.ViewComStockProductDetails
import com.fsmitc.features.task.presentation.AddTaskFragment
import com.fsmitc.features.task.presentation.CalenderTaskFragment
import com.fsmitc.features.task.presentation.EditTaskFragment
import com.fsmitc.features.task.presentation.TaskListFragment
import com.fsmitc.features.timesheet.presentation.AddTimeSheetFragment
import com.fsmitc.features.timesheet.presentation.EditTimeSheetFragment
import com.fsmitc.features.timesheet.presentation.TimeSheetListFragment
import com.fsmitc.features.viewAllOrder.CartFragment
import com.fsmitc.features.viewAllOrder.OrderTypeListFragment
import com.fsmitc.features.viewAllOrder.ViewAllOrderListFragment
import com.fsmitc.features.viewAllOrder.ViewCartFragment
import com.fsmitc.features.viewPPDDStock.ViewOutstandingFragment
import com.fsmitc.features.viewPPDDStock.ViewPPDDListFragment
import com.fsmitc.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.fsmitc.features.viewPPDDStock.ViewStockFragment
import com.fsmitc.features.weather.presentation.WeatherFragment
import com.fsmitc.mappackage.MapActivity
import com.fsmitc.mappackage.MapActivityWithoutPath
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xfsmitclogsample/log").path);
