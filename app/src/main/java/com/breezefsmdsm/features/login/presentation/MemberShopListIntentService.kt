...
//Rev 1.0 MemberShopListIntentService Suman 17-07-2023 mantis id 26586
...
class MemberShopListIntentService : IntentService("") {
    ...
    override fun onHandleIntent(intent: Intent?) {
        ...
        //Rev 1.0 MemberShopListIntentService Suman 17-07-2023 mantis id 26586 if else introduced
        if(Pref.isActivatePJPFeature){
            ...
            Timber.e("MemberShopListIntentService false")
