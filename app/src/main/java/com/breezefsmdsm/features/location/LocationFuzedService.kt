...
import com.breezefsmdsm.app.utils.AppUtils.Companion.getDateTimeFromTimeStamp
import com.breezefsmdsm.app.utils.AppUtils.Companion.isLocationActivityUpdating
...
import com.breezefsmdsm.base.presentation.BaseActivity.Companion.isMeetingUpdating
...
//3000(millliseconds in a second)*60(seconds in a minute)*5(number of minutes)=300000
    ...
    private fun shouldShopActivityUpdate(): Boolean {
        AppUtils.changeLanguage(this,"en")
        return if (abs(System.currentTimeMillis() - Pref.prevShopActivityTimeStamp) > 1000 * 60 * 30) {
