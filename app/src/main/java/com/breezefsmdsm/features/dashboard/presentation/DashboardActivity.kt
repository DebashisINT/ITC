...
import com.breezefsmdsm.app.NewFileUtils.getExtension
...
import com.breezefsmdsm.app.types.TopBarConfig
import com.breezefsmdsm.app.uiaction.DisplayAlert
import com.breezefsmdsm.app.utils.*
import com.breezefsmdsm.app.utils.AppUtils.Companion.isProfile
...
import com.breezefsmdsm.features.SearchLocation.SearchLocationFragment
...
import com.breezefsmdsm.features.achievement.AchievementFragment
import com.breezefsmdsm.features.activities.presentation.*
import com.breezefsmdsm.features.addAttendence.*
import com.breezefsmdsm.features.addorder.presentation.AddOrderFragment
...
import com.breezefsmdsm.features.addshop.presentation.AddShopFragment
import com.breezefsmdsm.features.addshop.presentation.OTPVerificationDialog
import com.breezefsmdsm.features.addshop.presentation.ScanImageFragment
import com.breezefsmdsm.features.addshop.presentation.ShowCardDetailsDialog
import com.breezefsmdsm.features.alarm.model.AlarmData
import com.breezefsmdsm.features.alarm.presetation.AttendanceReportFragment
...
import com.breezefsmdsm.features.billing.presentation.AddBillingFragment
import com.breezefsmdsm.features.billing.presentation.BillingDetailsFragment
import com.breezefsmdsm.features.billing.presentation.BillingListFragment
...
import com.breezefsmdsm.features.chat.model.ChatUserDataModel
import com.breezefsmdsm.features.chat.model.GroupUserDataModel
import com.breezefsmdsm.features.chat.presentation.*
import com.breezefsmdsm.features.chatbot.presentation.ChatBotFragment
import com.breezefsmdsm.features.chatbot.presentation.ChatBotShopListFragment
import com.breezefsmdsm.features.chatbot.presentation.ReportsFragment
import com.breezefsmdsm.features.chatbot.presentation.SelectLanguageDialog
...
import com.breezefsmdsm.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
...
import com.breezefsmdsm.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.breezefsmdsm.features.dailyPlan.prsentation.AllShopListFragment
import com.breezefsmdsm.features.dailyPlan.prsentation.DailyPlanListFragment
...
import com.breezefsmdsm.features.document.presentation.DocumentTypeListFragment
import com.breezefsmdsm.features.dymanicSection.presentation.AddDynamicFragment
import com.breezefsmdsm.features.dymanicSection.presentation.AllDynamicListFragment
import com.breezefsmdsm.features.dymanicSection.presentation.DynamicListFragment
import com.breezefsmdsm.features.dymanicSection.presentation.EditDynamicFragment
import com.breezefsmdsm.features.gpsDisabilityScreen.GpsDisableFragment
import com.breezefsmdsm.features.home.presentation.HomeFragment
import com.breezefsmdsm.features.homelocation.presentation.HomeLocationFragment
import com.breezefsmdsm.features.homelocation.presentation.HomeLocationMapFragment
import com.breezefsmdsm.features.know_your_state.KnowYourStateFragment
import com.breezefsmdsm.features.localshops.LocalShopListFragment
import com.breezefsmdsm.features.localshops.LocalShopListMapFragment
import com.breezefsmdsm.features.localshops.NearByShopsMapFragment
import com.breezefsmdsm.features.location.*
import com.breezefsmdsm.features.login.model.alarmconfigmodel.AlarmConfigDataModel
...
import com.breezefsmdsm.features.marketing.presentation.MarketingPagerFragment
import com.breezefsmdsm.features.meetinglist.prsentation.MeetingListFragment
import com.breezefsmdsm.features.member.model.TeamLocDataModel
import com.breezefsmdsm.features.member.model.TeamShopListDataModel
import com.breezefsmdsm.features.member.presentation.*
import com.breezefsmdsm.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.breezefsmdsm.features.micro_learning.presentation.MicroLearningListFragment
import com.breezefsmdsm.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.breezefsmdsm.features.myallowancerequest.MyallowanceRequestFragment
import com.breezefsmdsm.features.myjobs.model.CustomerDataModel
import com.breezefsmdsm.features.myjobs.presentation.*
import com.breezefsmdsm.features.myorder.presentation.MyOrderListFragment
import com.breezefsmdsm.features.myprofile.presentation.MyProfileFragment
import com.breezefsmdsm.features.nearbyshops.presentation.BeatListFragment
import com.breezefsmdsm.features.nearbyshops.presentation.NearByShopsListFragment
import com.breezefsmdsm.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.breezefsmdsm.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.breezefsmdsm.features.newcollection.CollectionDetailsStatusFragment
import com.breezefsmdsm.features.newcollection.CollectionShopListFragment
import com.breezefsmdsm.features.newcollection.NewCollectionListFragment
import com.breezefsmdsm.features.notification.NotificationFragment
import com.breezefsmdsm.features.orderList.NewDateWiseOrderListFragment
import com.breezefsmdsm.features.orderList.NewOrderListFragment
import com.breezefsmdsm.features.orderList.OrderListFragment
import com.breezefsmdsm.features.orderdetail.presentation.OrderDetailFragment
import com.breezefsmdsm.features.orderhistory.ActivityMapFragment
import com.breezefsmdsm.features.orderhistory.OrderhistoryFragment
import com.breezefsmdsm.features.orderhistory.TimeLineFragment
import com.breezefsmdsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezefsmdsm.features.orderhistory.model.FetchLocationRequest
import com.breezefsmdsm.features.orderhistory.model.FetchLocationResponse
import com.breezefsmdsm.features.orderhistory.model.LocationData
import com.breezefsmdsm.features.performance.GpsStatusFragment
import com.breezefsmdsm.features.performance.PerformanceFragment
...
import com.breezefsmdsm.features.reimbursement.presentation.ReimbursementFragment
import com.breezefsmdsm.features.reimbursement.presentation.ReimbursementListFragment
import com.breezefsmdsm.features.report.presentation.*
import com.breezefsmdsm.features.settings.presentation.SettingsFragment
import com.breezefsmdsm.features.shopdetail.presentation.*
import com.breezefsmdsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefsmdsm.features.stock.StockDetailsFragment
import com.breezefsmdsm.features.stock.StockListFragment
import com.breezefsmdsm.features.stockAddCurrentStock.AddShopStockFragment
import com.breezefsmdsm.features.stockAddCurrentStock.UpdateShopStockFragment
import com.breezefsmdsm.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.breezefsmdsm.features.stockCompetetorStock.AddCompetetorStockFragment
import com.breezefsmdsm.features.stockCompetetorStock.CompetetorStockFragment
import com.breezefsmdsm.features.stockCompetetorStock.ViewComStockProductDetails
import com.breezefsmdsm.features.task.presentation.AddTaskFragment
import com.breezefsmdsm.features.task.presentation.CalenderTaskFragment
import com.breezefsmdsm.features.task.presentation.EditTaskFragment
import com.breezefsmdsm.features.task.presentation.TaskListFragment
import com.breezefsmdsm.features.timesheet.presentation.AddTimeSheetFragment
import com.breezefsmdsm.features.timesheet.presentation.EditTimeSheetFragment
import com.breezefsmdsm.features.timesheet.presentation.TimeSheetListFragment
import com.breezefsmdsm.features.viewAllOrder.CartFragment
import com.breezefsmdsm.features.viewAllOrder.OrderTypeListFragment
import com.breezefsmdsm.features.viewAllOrder.ViewAllOrderListFragment
import com.breezefsmdsm.features.viewAllOrder.ViewCartFragment
import com.breezefsmdsm.features.viewPPDDStock.ViewOutstandingFragment
import com.breezefsmdsm.features.viewPPDDStock.ViewPPDDListFragment
import com.breezefsmdsm.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.breezefsmdsm.features.viewPPDDStock.ViewStockFragment
...
//            Log.w(TAG, errorMessage);
    ...
    override fun loadFragment(mFragType: FragType, addToStack: Boolean, initializeObject: Any) {
        ...
        println("load_frag "+mFragType.toString() + " gl: "+Pref.Show_App_Logout_Notification_Global + " usr: "+Pref.approvedOutTimeServerFormat)
        if (addToStack) {
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmdsmlogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmdsmlogsample/log.bak.1").path);
