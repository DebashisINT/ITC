...
import com.demo.CustomStatic
import com.demo.R
import com.demo.app.*
import com.demo.app.NewFileUtils.browseDocuments
import com.demo.app.NewFileUtils.getExtension
import com.demo.app.domain.*
import com.demo.app.types.DashboardType
import com.demo.app.types.FragType
import com.demo.app.types.TopBarConfig
import com.demo.app.uiaction.DisplayAlert
import com.demo.app.utils.*
import com.demo.app.utils.AppUtils.Companion.isProfile
...
import com.demo.features.SearchLocation.SearchLocationFragment
import com.demo.features.SearchLocation.locationInfoModel
import com.demo.features.TA.ViewAllTAListFragment
import com.demo.features.achievement.AchievementFragment
import com.demo.features.activities.presentation.*
import com.demo.features.addAttendence.*
import com.demo.features.addorder.presentation.AddOrderFragment
import com.demo.features.addshop.model.AddShopRequestData
import com.demo.features.addshop.model.AddShopResponse
import com.demo.features.addshop.presentation.AddShopFragment
import com.demo.features.addshop.presentation.OTPVerificationDialog
import com.demo.features.addshop.presentation.ScanImageFragment
import com.demo.features.addshop.presentation.ShowCardDetailsDialog
import com.demo.features.alarm.model.AlarmData
import com.demo.features.alarm.presetation.AttendanceReportFragment
import com.demo.features.alarm.presetation.PerformanceReportFragment
import com.demo.features.alarm.presetation.VisitReportDetailsFragment
import com.demo.features.alarm.presetation.VisitReportFragment
import com.demo.features.attendance.AttendanceFragment
import com.demo.features.averageshop.presentation.AverageShopFragment
import com.demo.features.avgorder.presentation.AverageOrderFragment
import com.demo.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.demo.features.billing.presentation.AddBillingFragment
import com.demo.features.billing.presentation.BillingDetailsFragment
import com.demo.features.billing.presentation.BillingListFragment
import com.demo.features.changepassword.presentation.ChangePasswordDialog
import com.demo.features.chat.model.ChatListDataModel
import com.demo.features.chat.model.ChatUserDataModel
import com.demo.features.chat.model.GroupUserDataModel
import com.demo.features.chat.presentation.*
import com.demo.features.chatbot.presentation.ChatBotFragment
import com.demo.features.chatbot.presentation.ChatBotShopListFragment
import com.demo.features.chatbot.presentation.ReportsFragment
import com.demo.features.chatbot.presentation.SelectLanguageDialog
import com.demo.features.commondialog.presentation.CommonDialog
import com.demo.features.commondialog.presentation.CommonDialogClickListener
import com.demo.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
...
import com.demo.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.demo.features.dailyPlan.prsentation.AllShopListFragment
import com.demo.features.dailyPlan.prsentation.DailyPlanListFragment
import com.demo.features.dailyPlan.prsentation.PlanDetailsFragment
import com.demo.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.demo.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.demo.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.demo.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.demo.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.demo.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.demo.features.dashboard.presentation.model.ContentListResponseModel
import com.demo.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.demo.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.demo.features.device_info.presentation.DeviceInfoListFragment
import com.demo.features.document.DocumentRepoFeatureNewFragment
import com.demo.features.document.presentation.DocumentListFragment
import com.demo.features.document.presentation.DocumentTypeListFragment
import com.demo.features.dymanicSection.presentation.AddDynamicFragment
import com.demo.features.dymanicSection.presentation.AllDynamicListFragment
import com.demo.features.dymanicSection.presentation.DynamicListFragment
import com.demo.features.dymanicSection.presentation.EditDynamicFragment
import com.demo.features.gpsDisabilityScreen.GpsDisableFragment
import com.demo.features.home.presentation.HomeFragment
import com.demo.features.homelocation.presentation.HomeLocationFragment
import com.demo.features.homelocation.presentation.HomeLocationMapFragment
import com.demo.features.know_your_state.KnowYourStateFragment
import com.demo.features.localshops.LocalShopListFragment
import com.demo.features.localshops.LocalShopListMapFragment
import com.demo.features.localshops.NearByShopsMapFragment
import com.demo.features.location.*
import com.demo.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.demo.features.login.presentation.LoginActivity
import com.demo.features.logout.presentation.api.LogoutRepositoryProvider
import com.demo.features.logoutsync.presentation.LogoutSyncFragment
import com.demo.features.marketing.presentation.MarketingPagerFragment
import com.demo.features.meetinglist.prsentation.MeetingListFragment
import com.demo.features.member.model.TeamLocDataModel
import com.demo.features.member.model.TeamShopListDataModel
import com.demo.features.member.presentation.*
import com.demo.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.demo.features.micro_learning.presentation.MicroLearningListFragment
import com.demo.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.demo.features.myallowancerequest.MyallowanceRequestFragment
import com.demo.features.myjobs.model.CustomerDataModel
import com.demo.features.myjobs.presentation.*
import com.demo.features.myorder.presentation.MyOrderListFragment
import com.demo.features.myprofile.presentation.MyProfileFragment
import com.demo.features.nearbyshops.presentation.BeatListFragment
import com.demo.features.nearbyshops.presentation.NearByShopsListFragment
import com.demo.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.demo.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.demo.features.newcollection.CollectionDetailsStatusFragment
import com.demo.features.newcollection.CollectionShopListFragment
import com.demo.features.newcollection.NewCollectionListFragment
import com.demo.features.notification.NotificationFragment
import com.demo.features.orderList.NewDateWiseOrderListFragment
import com.demo.features.orderList.NewOrderListFragment
import com.demo.features.orderList.OrderListFragment
import com.demo.features.orderdetail.presentation.OrderDetailFragment
import com.demo.features.orderhistory.ActivityMapFragment
import com.demo.features.orderhistory.OrderhistoryFragment
import com.demo.features.orderhistory.TimeLineFragment
import com.demo.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.demo.features.orderhistory.model.FetchLocationRequest
import com.demo.features.orderhistory.model.FetchLocationResponse
import com.demo.features.orderhistory.model.LocationData
import com.demo.features.performance.GpsStatusFragment
import com.demo.features.performance.PerformanceFragment
import com.demo.features.performance.api.UpdateGpsStatusRepoProvider
import com.demo.features.performance.model.UpdateGpsInputParamsModel
import com.demo.features.permissionList.ViewPermissionFragment
import com.demo.features.photoReg.ProtoRegistrationFragment
import com.demo.features.photoReg.RegisTerFaceFragment
import com.demo.features.quotation.presentation.*
import com.demo.features.reimbursement.presentation.EditReimbursementFragment
import com.demo.features.reimbursement.presentation.ReimbursementDetailsFragment
import com.demo.features.reimbursement.presentation.ReimbursementFragment
import com.demo.features.reimbursement.presentation.ReimbursementListFragment
import com.demo.features.report.presentation.*
import com.demo.features.settings.presentation.SettingsFragment
import com.demo.features.shopdetail.presentation.*
import com.demo.features.shopdetail.presentation.api.EditShopRepoProvider
import com.demo.features.stock.StockDetailsFragment
import com.demo.features.stock.StockListFragment
import com.demo.features.stockAddCurrentStock.AddShopStockFragment
import com.demo.features.stockAddCurrentStock.UpdateShopStockFragment
import com.demo.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.demo.features.stockCompetetorStock.AddCompetetorStockFragment
import com.demo.features.stockCompetetorStock.CompetetorStockFragment
import com.demo.features.stockCompetetorStock.ViewComStockProductDetails
import com.demo.features.task.presentation.AddTaskFragment
import com.demo.features.task.presentation.CalenderTaskFragment
import com.demo.features.task.presentation.EditTaskFragment
import com.demo.features.task.presentation.TaskListFragment
import com.demo.features.timesheet.presentation.AddTimeSheetFragment
import com.demo.features.timesheet.presentation.EditTimeSheetFragment
import com.demo.features.timesheet.presentation.TimeSheetListFragment
import com.demo.features.viewAllOrder.CartFragment
import com.demo.features.viewAllOrder.OrderTypeListFragment
import com.demo.features.viewAllOrder.ViewAllOrderListFragment
import com.demo.features.viewAllOrder.ViewCartFragment
import com.demo.features.viewPPDDStock.ViewOutstandingFragment
import com.demo.features.viewPPDDStock.ViewPPDDListFragment
import com.demo.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.demo.features.viewPPDDStock.ViewStockFragment
import com.demo.features.weather.presentation.WeatherFragment
import com.demo.mappackage.MapActivity
import com.demo.mappackage.MapActivityWithoutPath
