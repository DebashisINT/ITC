...
import com.breezedsm.features.SearchLocation.SearchLocationFragment
import com.breezedsm.features.SearchLocation.locationInfoModel
import com.breezedsm.features.TA.ViewAllTAListFragment
import com.breezedsm.features.achievement.AchievementFragment
import com.breezedsm.features.activities.presentation.*
import com.breezedsm.features.addAttendence.*
import com.breezedsm.features.addorder.presentation.AddOrderFragment
...
import com.breezedsm.features.addshop.presentation.AddShopFragment
import com.breezedsm.features.addshop.presentation.OTPVerificationDialog
import com.breezedsm.features.addshop.presentation.ScanImageFragment
import com.breezedsm.features.addshop.presentation.ShowCardDetailsDialog
import com.breezedsm.features.alarm.model.AlarmData
import com.breezedsm.features.alarm.presetation.AttendanceReportFragment
import com.breezedsm.features.alarm.presetation.PerformanceReportFragment
import com.breezedsm.features.alarm.presetation.VisitReportDetailsFragment
import com.breezedsm.features.alarm.presetation.VisitReportFragment
import com.breezedsm.features.attendance.AttendCalendarFrag
import com.breezedsm.features.attendance.AttendSummaryFrag
import com.breezedsm.features.attendance.AttendanceFragment
import com.breezedsm.features.attendance.CalculatorFrag
...
import com.breezedsm.features.averageshop.presentation.AverageShopFragment
import com.breezedsm.features.avgorder.presentation.AverageOrderFragment
import com.breezedsm.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.breezedsm.features.billing.presentation.AddBillingFragment
import com.breezedsm.features.billing.presentation.BillingDetailsFragment
import com.breezedsm.features.billing.presentation.BillingListFragment
import com.breezedsm.features.changepassword.presentation.ChangePasswordDialog
import com.breezedsm.features.chat.model.ChatListDataModel
import com.breezedsm.features.chat.model.ChatUserDataModel
import com.breezedsm.features.chat.model.GroupUserDataModel
import com.breezedsm.features.chat.presentation.*
import com.breezedsm.features.chatbot.presentation.ChatBotFragment
import com.breezedsm.features.chatbot.presentation.ChatBotShopListFragment
import com.breezedsm.features.chatbot.presentation.ReportsFragment
import com.breezedsm.features.chatbot.presentation.SelectLanguageDialog
...
import com.breezedsm.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
...
import com.breezedsm.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.breezedsm.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.breezedsm.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.breezedsm.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.breezedsm.features.dashboard.presentation.model.*
import com.breezedsm.features.device_info.presentation.DeviceInfoListFragment
import com.breezedsm.features.document.DocumentRepoFeatureNewFragment
import com.breezedsm.features.document.presentation.DocumentListFragment
import com.breezedsm.features.document.presentation.DocumentTypeListFragment
import com.breezedsm.features.dymanicSection.presentation.AddDynamicFragment
import com.breezedsm.features.dymanicSection.presentation.AllDynamicListFragment
import com.breezedsm.features.dymanicSection.presentation.DynamicListFragment
import com.breezedsm.features.dymanicSection.presentation.EditDynamicFragment
import com.breezedsm.features.gpsDisabilityScreen.GpsDisableFragment
import com.breezedsm.features.home.presentation.HomeFragment
import com.breezedsm.features.homelocation.presentation.HomeLocationFragment
import com.breezedsm.features.homelocation.presentation.HomeLocationMapFragment
import com.breezedsm.features.know_your_state.KnowYourStateFragment
import com.breezedsm.features.localshops.LocalShopListFragment
import com.breezedsm.features.localshops.LocalShopListMapFragment
import com.breezedsm.features.localshops.NearByShopsMapFragment
import com.breezedsm.features.location.*
import com.breezedsm.features.login.model.alarmconfigmodel.AlarmConfigDataModel
...
import com.breezedsm.features.marketing.presentation.MarketingPagerFragment
import com.breezedsm.features.meetinglist.prsentation.MeetingListFragment
import com.breezedsm.features.member.model.TeamLocDataModel
import com.breezedsm.features.member.model.TeamShopListDataModel
import com.breezedsm.features.member.presentation.*
import com.breezedsm.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.breezedsm.features.micro_learning.presentation.MicroLearningListFragment
import com.breezedsm.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.breezedsm.features.myallowancerequest.MyallowanceRequestFragment
import com.breezedsm.features.myjobs.model.CustomerDataModel
import com.breezedsm.features.myjobs.presentation.*
import com.breezedsm.features.myorder.presentation.MyOrderListFragment
import com.breezedsm.features.myprofile.presentation.MyProfileFragment
import com.breezedsm.features.nearbyshops.presentation.BeatListFragment
import com.breezedsm.features.nearbyshops.presentation.NearByShopsListFragment
import com.breezedsm.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.breezedsm.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.breezedsm.features.newcollection.CollectionDetailsStatusFragment
import com.breezedsm.features.newcollection.CollectionShopListFragment
import com.breezedsm.features.newcollection.NewCollectionListFragment
import com.breezedsm.features.notification.NotificationFragment
import com.breezedsm.features.orderList.NewDateWiseOrderListFragment
import com.breezedsm.features.orderList.NewOrderListFragment
...
import com.breezedsm.features.orderhistory.model.FetchLocationRequest
import com.breezedsm.features.orderhistory.model.FetchLocationResponse
import com.breezedsm.features.orderhistory.model.LocationData
import com.breezedsm.features.performance.GpsStatusFragment
import com.breezedsm.features.performance.PerformanceFragment
...
import com.breezedsm.features.permissionList.ViewPermissionFragment
import com.breezedsm.features.photoReg.*
import com.breezedsm.features.quotation.presentation.*
import com.breezedsm.features.reimbursement.presentation.EditReimbursementFragment
import com.breezedsm.features.reimbursement.presentation.ReimbursementDetailsFragment
import com.breezedsm.features.reimbursement.presentation.ReimbursementFragment
import com.breezedsm.features.reimbursement.presentation.ReimbursementListFragment
import com.breezedsm.features.report.presentation.*
import com.breezedsm.features.settings.presentation.SettingsFragment
import com.breezedsm.features.shopdetail.presentation.*
import com.breezedsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezedsm.features.stock.StockDetailsFragment
import com.breezedsm.features.stock.StockListFragment
import com.breezedsm.features.stockAddCurrentStock.AddShopStockFragment
import com.breezedsm.features.stockAddCurrentStock.UpdateShopStockFragment
import com.breezedsm.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.breezedsm.features.stockCompetetorStock.AddCompetetorStockFragment
import com.breezedsm.features.stockCompetetorStock.CompetetorStockFragment
import com.breezedsm.features.stockCompetetorStock.ViewComStockProductDetails
import com.breezedsm.features.task.presentation.AddTaskFragment
import com.breezedsm.features.task.presentation.CalenderTaskFragment
import com.breezedsm.features.task.presentation.EditTaskFragment
import com.breezedsm.features.task.presentation.TaskListFragment
import com.breezedsm.features.timesheet.presentation.AddTimeSheetFragment
import com.breezedsm.features.timesheet.presentation.EditTimeSheetFragment
import com.breezedsm.features.timesheet.presentation.TimeSheetListFragment
import com.breezedsm.features.viewAllOrder.CartFragment
import com.breezedsm.features.viewAllOrder.OrderTypeListFragment
import com.breezedsm.features.viewAllOrder.ViewAllOrderListFragment
import com.breezedsm.features.viewAllOrder.ViewCartFragment
import com.breezedsm.features.viewPPDDStock.ViewOutstandingFragment
import com.breezedsm.features.viewPPDDStock.ViewPPDDListFragment
import com.breezedsm.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.breezedsm.features.viewPPDDStock.ViewStockFragment
import com.breezedsm.features.weather.presentation.WeatherFragment
import com.breezedsm.mappackage.MapActivity
import com.breezedsm.mappackage.MapActivityWithoutPath
...
import com.breezedsm.features.privacypolicy.PrivacypolicyWebviewFrag
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            ...
            //val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezedsmlogsample/log").path);
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezedsmlogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezedsmlogsample/log.bak.1").path);
