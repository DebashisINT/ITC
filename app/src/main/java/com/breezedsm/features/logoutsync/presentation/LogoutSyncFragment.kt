package com.breezedsm.features.logoutsync.presentation
...
import com.breezedsm.features.addshop.model.AddLogReqData
...
import com.breezedsm.features.billing.api.AddBillingRepoProvider
...
import com.breezedsm.features.document.model.AddEditDocumentInputParams
import com.breezedsm.features.document.model.DocumentAttachmentModel
...
import com.breezedsm.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.breezedsm.features.nearbyshops.model.updateaddress.AddressUpdateRequest
...
import com.breezedsm.features.orderhistory.model.*
...
import com.breezedsm.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezedsm.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
import com.breezedsm.features.stock.api.StockRepositoryProvider
import com.breezedsm.features.stock.model.AddStockInputParamsModel
import com.breezedsm.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezedsm.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.breezedsm.features.timesheet.model.AddTimeSheetInputModel
import com.breezedsm.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezedsm.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezedsm.features.viewAllOrder.model.AddOrderInputProductList
...
//            calllogoutApi(Pref.user_id!!, Pref.session_token!!)
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezedsmlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezedsmlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezedsmlogsample/log.zip").path);
